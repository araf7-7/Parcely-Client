...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y font-abc font-medium dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                            <div className="flex items-center justify-center w-24 h-24 rounded-full ">
                                <img src="https://i.ibb.co/p0xHgqx/Red-Modern-Business-Truck-Car-Negative-Space-Logo-removebg-preview.png" alt="" />
                            </div>
                            <span className="self-center text-2xl font-semibold">Parcely</span>
                        </a>
                    </div>
