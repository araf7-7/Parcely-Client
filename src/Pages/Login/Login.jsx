    ...
    return (
        <><div className="min-h-screen  text-gray-900 flex justify-center">
            ...
            <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            <div className="flex flex-col items-center">
                                ...
                                <button  className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 to-[#64c0cb] from-[#53b5c2] text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                ...
                <div className="flex-1 rounded-e-lg  bg-gradient-to-r to-[#64c0cb] from-[#53b5c2] text-center hidden lg:flex">
                    <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style={{ backgroundImage: "url('https://media.istockphoto.com/id/1321172733/photo/courier.jpg?s=612x612&w=0&k=20&c=L7Znfesk9H9kUMZX1GTP5SFfx__5RtaZG7aw50FE3p8=')" }}></div>
                </div>
            </div>
        </div>
